describe('Тестирование переходов по страницам', () => {
    ...
    it('Переход на страницу sorting и обратно на главную страницу', () => {
    ...
    it('Переход на страницу stack и обратно на главную страницу', () => {
    ...
    it('Переход на страницу string и обратно на главную страницу', () => {
